...
if __name__ == '__main__':
	...
	with open(fname, 'r') as f:
		...
		tweets_with_hashtags = sum([count for n_of_hashtags, count in hashtag_count.items() if n_of_hashtags > 0])
		...
		print("{} tweets with atleast one hashtag ({}%)".format(tweets_with_hashtags, tweets_with_hashtags_percent))
